...
@section('title', 'Edit Taman Wisata')

@section('content')
<div class="bg-white rounded-lg shadow">
    <div class="p-6">
        <form action="{{ route('admin.taman-wisatas.update', $tamanWisata) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="name" id="name" 
                           ...
                           value="{{ old('name', $tamanWisata->name) }}" required>
                    @error('name')
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="4" 
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                            required>{{ old('description', $tamanWisata->description) }}</textarea>
                    @error('description')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="location" id="location" 
                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                           value="{{ old('location', $tamanWisata->location) }}" required>
                    @error('location')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="text" 
                           ...
                           id="rating" 
                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                           value="{{ old('rating', $tamanWisata->rating) }}" 
                           required
                ...
                <div>
                    ...
                    <div class="mt-1 flex rounded-md shadow-sm">
                        ...
                        <input type="text" 
                               ...
                               value="{{ old('wa_admin', $tamanWisata->wa_admin) }}" 
                               required
                               maxlength="13"
                               pattern="[0-9]{10,13}"
                ...
                <div>
                        ...
                        @foreach($tamanWisata->images as $image)
                            <div class="relative group w-[100px] h-[100px]">
                                <img src="{{ asset('storage/' . $image->image_path) }}" 
                                     alt="Taman Wisata Image" 
                                     class="w-[100px] h-[100px] object-cover bg-gray-50 rounded border border-gray-200">
                    ...
                    <p class="mt-1 text-xs text-gray-500">Hover and check images to delete them</p>
                </div>
                ...
                <div>
                    ...
                    <div class="mt-1 border border-gray-300 border-dashed rounded-md p-2">
                        <div class="flex flex-col items-center">
                            <label for="new_images" class="w-full cursor-pointer">
                                <div class="flex items-center justify-center space-x-2">
                                    <svg class="h-4 w-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/>
                                    </svg>
                                    <span class="text-sm text-blue-600 hover:text-blue-500">Upload images</span>
                                </div>
